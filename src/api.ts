...
export type Match={id:string;opponent:string;previous_opponent?:string|null;kuriyama_side:'HOME'|'AWAY';kickoff_at:string;picks_close_at:string;status:string;kuriyama_score:number|null;opponent_score:number|null}
...
export type Standing={id:string;group_name:string;place:number|null;team:string;played:number|null;won:number|null;drawn:number|null;lost:number|null;goals_for:number|null;goals_against:number|null;goal_difference:number|null;penalty_points:number|null;points:number|null;sort_order:number}
